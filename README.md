...
依据《项目规划.md》v2.1 实施。按用户明确决定，KFF 独立拥有客户、订单、聊天与数据，见 [ADR-017](docs/decisions/017-independent-business-data.md)。目前已有本地执行、数据导入与查询、计划规则、自有咨询收件和客户基础；完整项目、人工回复、订单流程、真实 Facebook 和设备验收仍在后续范围。
