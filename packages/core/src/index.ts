...
export function buildDiagnostic(report: { step: string; scene?: Record<string, number>; duration_ms?: number; executor_version?: string; browser_version?: string }, errorCode: string | undefined, scope: { organization_id: string; brand_id: string }, actionId: string, execution?: { adapter_version: string; attempt_id: string; outcome: ActionState }) {
