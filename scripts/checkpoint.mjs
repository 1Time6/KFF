...
for (const card of ledger.tasks) {
  ...
  if (['TASK-090','TASK-093'].includes(card.task_id)) {card.evidence_refs.push('docs/tasks/g3-owned-orders.md','docs/decisions/017-independent-business-data.md');card.known_blockers=['自有商品、报价和待核实订单基础已验；实际支付服务商尚未指定，可信支付核验/退款/交付及公共结账未完成，未发生真实收款'];}
}
