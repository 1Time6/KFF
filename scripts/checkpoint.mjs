...
for (const card of ledger.tasks) {
  ...
  if (['TASK-090','TASK-093'].includes(card.task_id)) {card.evidence_refs.push('docs/tasks/g3-owned-orders.md','docs/decisions/017-independent-business-data.md','docs/decisions/018-stripe-phase-one.md');card.known_blockers=['自有商品、报价与订单基础已验，Stripe 支付代码已按用户选择实现并本地验证；实际 Stripe 测试联调、退款、交付及访客自主结账尚待完成，未发生真实收款'];}
